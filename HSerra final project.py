"""
Program: Dream adventure.py
Author:  Heather Serra
Course:  SDEV-140
This is a text adventure game that lets you choose where the story goes.
"""
from tkinter import *
root = Tk()
root.title('Dream Adventure')  # my title
...
# for every label and or buttons a frame comes up sometimes it is a repeating frame
